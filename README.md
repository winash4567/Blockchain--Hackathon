...
Clone the repository: git clone https://www.google.com/search?q=https://github.com/YOUR-USERNAME/kaaval-hackathon-project.git cd kaaval-hackathon-project

Install Flask: python -m pip install Flask

Run the application: python main.py

Open your web browser and go to: https://www.google.com/search?q=http://127.0.0.1:5000

Demo Flow & User Logins

Use these pre-set accounts to test the role-based features. Password for all users: pass

Username: si_state Role: SI Department: State Police

Username: si_cyber Role: SI Department: Cyber Crime

Username: si_cbi Role: SI Department: CBI

Username: constable_state Role: Constable Department: State Police

Username: judge1 Role: Judge Department: Judiciary
...
The "tampering" (the illegitimate transfer) is permanently recorded, with the culprit's name (si_state) and the exact timestamp.Blockchain-based evidence ledger for T.N. Kaaval Hackathon 2025.
